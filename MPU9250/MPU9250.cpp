/******************************************************************************
MPU9250.cpp - MPU-9250 DMP Processor Arduino Library
Specialization of the original SparkFunMPU9250-DMP, whose credits are reported
hereafter. 
Just few, meaningless functions have been modified, plus the initialization, 
that defaults to 400KHz bus instead of the original speed, 100KHz
...
inv_error_t MPU9250_DMP::begin(void)
{
	...
	Wire.begin(I2C_MASTER, 0, I2C_PINS_18_19, I2C_PULLUP_EXT, 400000);
...
void MPU9250_DMP::getData(float a[3], float g[3], float m[3], float &T)
{
